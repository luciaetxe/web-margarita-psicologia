...
- Precios (15-09-2026): 1 h 30 → 100 € con 120 € tachado (la hora vale 80 €, así que es un descuento real, no un "antes"); 1 h → 80 €; "Adultos" aparece una sola vez como cabecera del grupo, con "1 h 30 min" y "1 h" debajo; "Infantil y familias · se concreta en la llamada" en una sola línea. Seguimiento por WhatsApp entre sesiones incluido. Llamada de valoración gratuita, 15 min. Datos en `src/data/precios.json`.
